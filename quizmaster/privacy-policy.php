                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    $policyMessageEs = getSettingMessage($db, 'privacy_policy_es', 'privacy_policy');
                                    $policyMessageEn = getSettingMessage($db, 'privacy_policy_en');
                                    ?>
                                    <div class="col-md-offset-1 col-md-6">
                                        <h4>Privacy Policy <small>Bilingual content for App Usage</small></h4>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <form id="policy_form"  method="POST" action ="db_operations.php"data-parsley-validate class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-2" for="message_es">Privacy Policy ES</label>
                                            <div class="col-md-9">
                                                <textarea name='message_es' id='policy_es' class='form-control'><?= $policyMessageEs; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-2" for="message_en">Privacy Policy EN</label>
                                            <div class="col-md-9">
                                                <textarea name='message_en' id='policy_en' class='form-control'><?= $policyMessageEn; ?></textarea>
                                            </div>
                                        </div>
