 ...
 * @Package Database
 */
define('DOMAIN_URL', 'https://adrianrol87.com.mx/quizmaster/');
define('JWT_SECRET_KEY', 'quizmaster2026');
...
class Database {
    ...
    private $db_user = 'adrianr9_adrianrol87';  // Change as required
    private $db_pass = 'quizmaster2026';  // Change as required 
    private $db_name = 'adrianr9_quizmaster'; // Change as required
